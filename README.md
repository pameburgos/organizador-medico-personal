...
## Funcionalidades
### Dashboard general
Vista rápida con contadores de especialidad, consultas, documentos y medicamentos activos. Muestra las próximas toma de medicamentos y consultas programadas de un vistazo.
...
![Especialidades](fotos/especialidad.png)

### Consultas
Calendario visual de turnos con vista de 3 meses (mes pasado/mes actual/mes proximo). Cada consulta se asocia a una especialidad, con fecha, hora, lugar, motivo y notas post-consulta. Permite filtrar por próxima o realizada.
![Consultas](fotos/consulta.png)
...
![Documentos](fotos/documento.png)
...
![Medicamentos](fotos/medicamento.png)
